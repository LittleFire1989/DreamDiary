...
public class ExploreActivity extends Activity {
	...
	Handler handler = new Handler() {
		...
		public void handleMessage(Message msg) {
			...
			/*
			 * w.setId(); w.setUserId(userId); w.setUserName(userName);
			 * w.setTime(time); w.setText(text);
			 * 
			 * w.setHaveImage(haveImg); w.setUserIcon(userIcon); wbList.add(w);
			 */
			// wbList.add(w);
	...
	public class ShareAdapter extends BaseAdapter {
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			...
			// ImageView tempIV = (ImageView)
			// convertView.findViewById(R.id.wbicon);
			TextView tempTV = (TextView) convertView
					.findViewById(R.id.dreamDetailstextView);
			// wh.wbtime = (TextView) convertView.findViewById(R.id.wbtime);
			TextView tempUser = (TextView) convertView
					.findViewById(R.id.userNameTextView);
			TextView tempDate = (TextView) convertView
					.findViewById(R.id.dateTextView);
			// wh.wbimage = (ImageView) convertView.findViewById(R.id.wbimage);
			ImageView tempImage = (ImageView) convertView
					.findViewById(R.id.userPhotoImageView);
			Share wb = wbList.get(position);
			if (wb != null) {
				convertView.setTag(wb.getShareID());
				tempTV.setText(wb.getMessage());
				tempUser.setText(wb.getUserName(),
						TextView.BufferType.SPANNABLE);
				tempDate.setText(wb.getPosttime());
				if (wb.getUserName().equals("allen"))
					tempImage.setImageResource(R.drawable.allen_photo);
				else if (wb.getUserName().equals("mandy"))
					tempImage.setImageResource(R.drawable.mandy_photo);
				else if (wb.getUserName().equals("YueZhao"))
					tempImage.setImageResource(R.drawable.yue_photo);
				else if (wb.getUserName().equals("Rubby"))
					tempImage.setImageResource(R.drawable.yue_photo);
				else
					tempImage.setImageResource(R.drawable.save);
