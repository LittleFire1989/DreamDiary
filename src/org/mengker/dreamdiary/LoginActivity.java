...
public class LoginActivity extends Activity {
   ...
   mButton1.setOnClickListener(new OnClickListener() {
        ...
        public void onClick(View v) {
                ...
                qq.QDatabase=openOrCreateDatabase(qq.DATABASE_NAME,  MODE_PRIVATE, null);//打开数据库
                //~~~~~~~~~~~~~~~~~~用Cursor类来接收查询到的数据~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
                Cursor cursor=qq.QDatabase.query(qq.TABLE_NAME, new String[]{qq.QQ,qq.PASS}, null, null, null, null, null);
                //~~~~~~~~~~~~~~~~~用do..while循环验证文本框输入的内容是否和数据库的吻合，是就将flag改为true~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
                if(cursor!=null){
                        if(cursor.moveToFirst()){
                                do {
                                        if(q.equals(cursor.getString(0))&&pass.equals(cursor.getString(1))){
                                        flag=true;
                                        }
